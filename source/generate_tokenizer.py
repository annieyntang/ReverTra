...
mask_translator_dict = {
    tokenizer.token_to_id(c): tokenizer.token_to_id("<mask_" + translate(c) + ">")
    for c in codons
}
mask_translator_dict = {
    **mask_translator_dict,
    **{tokenizer.token_to_id(c): tokenizer.token_to_id(c) for c in mask_tokens},
}
mask_translator_dict = {
    **mask_translator_dict,
    **{tokenizer.token_to_id(c): tokenizer.token_to_id(c) for c in special_tokens},
}
mask_translator_dict = {
    **mask_translator_dict,
    **{tokenizer.token_to_id(c): tokenizer.token_to_id(c) for c in species_tokens},
}
