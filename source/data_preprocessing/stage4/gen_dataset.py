...
def gendb(data_path):
    homologs_train_path = os.path.join(args.data_path,args.dataset_name+'_'+args.dataset_name+'_'+str(0)+'_homologs.expr.csv')
    homologs_test_path = os.path.join(args.data_path,args.dataset_name+'_'+args.dataset_name+'_'+str(2)+'_homologs.expr.csv')
    ...
    homologs_val_path = os.path.join(args.data_path,args.dataset_name+'_'+args.dataset_name+
            '_'+str(1)+'_homologs.nonoverlaping_win'+str(args.win_size)+'.expr.csv') 

    dataset_output_path = os.path.join(args.data_path,args.dataset_name+'_'+args.dataset_name +"_ExprRefined"+str(args.win_size)) 
