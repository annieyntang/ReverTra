...
parser.add_argument(
    "--data_path",
    type=str,
    default="/home/tomer/COnTRA/data/datasets/processed_data_SCPECBS3/homologs",
...
parser.add_argument("--win_size", type=int, default="75", help=".")
...
def gendb(data_path):
    homologs_train_path = os.path.join(
        args.data_path,
        args.dataset_name + "_" + args.dataset_name + "_" + str(0) + "_homologs.csv",
    )
    homologs_test_path = os.path.join(
        args.data_path,
        args.dataset_name + "_" + args.dataset_name + "_" + str(2) + "_homologs.csv",
    )
    # homologs_val_path = os.path.join(args.data_path,args.species1+'_'+args.species2+'_'+str(1)+'_homologs.csv')
    homologs_val_path = os.path.join(
        args.data_path,
        args.dataset_name
        + "_"
        + args.dataset_name
    ...
    dataset_output_path = os.path.join(
        args.data_path,
        args.dataset_name + "_" + args.dataset_name + "_" + str(args.win_size),
    )
    data_columns = [
        "qseqid",
        "sseqid",
    ...
    data_files = {
        "train": homologs_train_path,
        "val": homologs_val_path,
        "test": homologs_test_path,
    }
