...
parser.add_argument(
    "--rawdata_path",
    type=str,
    default="/home/tomer/ReverTra/data/raw_data",
    help="location of the raw rna and protein abundance data.",
)
parser.add_argument(
    "--data_path",
    type=str,
    default="/home/tomer/ReverTra/data/processed_data",
    help="location of the processed data.",
)
parser.add_argument(
    "--log_path",
    type=str,
    default="/home/tomer/ReverTra/data/logs",
    help="location of the processed data.",
)
parser.add_argument(
    "--agg_seqs_path",
    type=str,
    default="/home/tomer/ReverTra/data/logs/agg_seqs.temp.fasta",
    help="location of the translated AA sequences of all sequences (for cd-hit).",
)
parser.add_argument(
    "--cdhit_exec",
    type=str,
    default="/home/tomer/lib/cdhit/cd-hit",
    help="location of the cd-hit program execution file.",
)
parser.add_argument(
    "--cdhit_log",
    type=str,
    default="/home/tomer/ReverTra/data/logs/cdhit.log",
